...
class Base:
    ...
    def __GetCaptchaFromMail__(self,captcha_element):
        ...
        if self.debug: # Development Run
            ...
            # mail.To = 'hiepdang@phs.vn; namtran@phs.vn; thaonguyenthanh@phs.vn; vanho@phs.vn'
            mail.To = 'namtran@phs.vn'
        ...
        <html>
            ...
            <body>
                ...
                <p style="font-family:Times New Roman; font-size:100%"><i>
                    Hệ thống không đọc được CAPTCHA <br>
                    Vui lòng REPLY ALL mail này với nội dung CAPTCHA để tiếp tục
                </i></p>
...
class BIDV(Base):
    ...
    def Login(self):
        ...
        while True:
            ...
            condition2 = not re.findall('[^a-zA-Z\d]',predictedCAPTCHA)
...
class VCB(Base):
    ...
    def Login(self):
        ...
        while True:
            ...
            print(predictedCAPTCHA)
            condition1 = len(predictedCAPTCHA) == 6
            condition2 = not re.findall('[^\dA-Z]',predictedCAPTCHA)
...
class SCSB(Base):
    ...
    def Login(self):
        ...
        while True:
            ...
            imgPATH = join(dirname(__file__),'CAPTCHA',f'{self.bank}.png')
            CAPTCHA.screenshot(imgPATH)  # download CAPTCHA về dưới dạng .png
            predictedCAPTCHA = re.sub('\D','',pytesseract.image_to_string(imgPATH))
            print(predictedCAPTCHA)
...
class SINOPAC(Base):
    ...
    def Login(self):
        ...
        # Bỏ qua thông báo "Duplicate Login" nếu có
        xpath = '//*[contains(text(),"Yes, continue login")]'
        Buttons = self.driver.find_elements(By.XPATH,xpath)
        if Buttons:
            Buttons[0].click()
...
class HUANAN(Base):
    ...
    def Login(self):
        ...
        while True:
            waitElements = self.driver.find_elements(By.XPATH,xpath)
            if not waitElements:
                break
            time.sleep(1) # chưa load xong -> chờ 1s
