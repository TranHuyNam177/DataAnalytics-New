...
def run(
    ...
    file_name = f'Danh sách KH đóng mở ủy quyền tài khoản PHS (old) HOSE - từ {startDate} đến {endDate}.xlsx'
    ...
    if startMonth == endMonth and startYear == endYear:
        ...
        timePeriod = f'{convert_int(startMonth)}.{startYear} TỚI THÁNG {convert_int(endMonth)}.{endYear}'

    sheet_motaikhoan.merge_range('A4:K4',f'DANH SÁCH KHÁCH HÀNG MỞ TÀI KHOẢN THÁNG {timePeriod}',sup_title_format)
    ...
    sheet_dongtaikhoan.merge_range('A4:L4',f'DANH SÁCH KHÁCH HÀNG ĐÓNG TÀI KHOẢN THÁNG {timePeriod}',sup_title_format)
    ...
    sheet_thaydoithongtin.merge_range('A4:P4',f'DANH SÁCH KHÁCH HÀNG THAY ĐỔI THÔNG TIN THÁNG {timePeriod}',sup_title_format)
    ...
    sheet_uyquyen.merge_range('A4:J4',f'DANH SÁCH KHÁCH HÀNG ỦY QUYỀN THÁNG {timePeriod}',sup_title_format)
    ...
    sheet_thaydoiuyquyen.merge_range('A4:P4',f'DANH SÁCH KHÁCH HÀNG THAY ĐỔI ỦY QUYỀN GIAO DỊCH THÁNG {timePeriod}',sup_title_format)
