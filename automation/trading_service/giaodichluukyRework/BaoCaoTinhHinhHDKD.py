...
def run(
    ...
    ytd_trading_record = pd.read_sql(
        ...
        AND [trading_record].[date] BETWEEN '{begin_of_year}' AND '{end_date}'
    ...
    file_name = f'Báo cáo tình hình HĐKD (Biểu II.6) từ {startDate} đến {endDate}.xlsx'
    ...
    worksheet.merge_range('A1:N1', f'Báo Cáo Tình Hình HĐKD - Biểu II.6 - {timePeriod}', title_format)
